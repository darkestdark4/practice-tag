<template>
  <div class="q-pa-lg font-monserra">
    ...
    <div class="row">
      <div class="col-8 text-left q-mb-md q-mt-sm">
    ...
    <div class="col row q-mb-md q-my-md" v-for="(mem, index) in userFilter" :key="index">
      <div class="col-1 q-mr-md q-mt-sm">
        <q-avatar size="50px">
          <q-img
            alt="Profile Logo"
      ...
      <div class="col-7 row text-left q-ml-lg">
      ...
      <div class="col-2 row text-right q-ml-md" v-if="sponsorData.length > 1">
        <span
