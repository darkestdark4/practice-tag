<template>
  <div class="q-pa-sm font-monserrat">
    ...
    <div class="q-my-sm row">
      ...
      <q-img class="col-2 q-mr-md" alt="Profile Logo" v-if="data.icon" :src="iconFilter.image" width="40px" height="40px" />
            ...
            <q-carousel-slide v-for="br in dataCeil" :key="br" :name="br" class="column">
              <div class="row">
                <div class="col-3 q-my-sm text-center column" v-for="brd in Shortcut.slice(br*12-12, br*12)" :key="brd" :name="brd">
                  ...
                  v-model="data.icon" :val="brd.id" color="teal" size="md" checked-icon="task_alt" unchecked-icon="panorama_fish_eye" />
