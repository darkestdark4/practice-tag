<template>
  <div class="q-pa-sm font-monserrat">
    ...
    <div class="q-pa-sm">
          ...
          <div class="col q-mb-lg" v-for="(office, idx) in officeList" :key="idx">
            <q-input class="full-width" @change="updateStore()" style="margin-top:-20px" readonly
              outlined :disabled="data.member.role == 'Anggota'">
                <template v-slot:prepend>
                  <span class="text-body2 text-black">
                    {{ office.corporate_address }}, {{ office.city.name }}, {{ office.state.name }}, {{ office.country.name }} - {{ office.corporate_postal_code }}
                  </span>
                </template>
            </q-input>
            <div class="row">
        ...
        <div class="q-my-md column" v-if="data.member.role == 'Admin'">
          ...
          <div class="row">
            <q-btn v-if="$store.state.userdata.corporate.file_pdf"
              class="q-mt-md col-grow bg-secondary text-white font-proxima-nova-alt border-radius-10px q-px-sm"
              style="height: 50px" :label="$store.state.userdata.corporate.file_pdf"
            ...
            <q-btn v-if="$store.state.userdata.corporate.file_pdf"
              ...
              style="height: 50px" label="Delete" @click="deletePdfCorporate()" />
          </div>
          ...
          <div class="row">
            <q-btn v-if="data.member.corporate.background !== null"
              class="q-mt-md col-grow bg-secondary text-white font-proxima-nova-alt border-radius-10px q-px-sm"
              style="height: 50px" :label="data.member.corporate.background"
              @click="showBGView(data.member.corporate.background)" />
            <q-btn v-if="data.member.corporate.background !== null"
              class="q-mt-md col-3 offset-1 bg-red text-white font-proxima-nova-alt border-radius-10px q-px-sm"
              style="height: 50px" label="Delete" @click="deleteBGCorporate()" />
          </div>
        </div>
      ...
      <q-separator />
      <div class="q-my-md" v-if="data.member.role == 'Admin'">
        ...
        <div class="row q-my-md">
          <div class="q-pa-sm col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
            ...
            <q-color v-model="data.corporate.corporate_main_color" dark default-view="palette" class="my-picker" />
          </div>
          <div class="q-pa-sm col-xl-6 col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="q-mb-sm">
            ...
            <q-color v-model="data.corporate.corporate_secondary_color" dark default-view="palette" class="my-picker" />
          </div>
        </div>
      </div>
      <div class="q-my-md" v-if="!data.member.corporate_id">
