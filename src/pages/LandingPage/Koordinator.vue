          ...
          <div class="row font-proxima-nova">
            <div class="col-11 q-my-sm q-mx-md" style="margin-top: -12px">
              ...
              <q-input
                ...
                v-model="data.gereja"
                @focus="selectOnFocus"
                @blur="selectOnBlur($event, 'GBI Efrata Banyuwangi')"
                :error="$v.data.gereja.$error"
                :error-message="validationMsg($v.data.gereja)"
                placeholder="GBI Efrata Banyuwangi"
                outlined
                dense
              />
            </div>
            <div class="col-11 q-my-sm q-mx-md" style="margin-top: -12px">
              <span
                class="text-white text-left"
                style="font-style: italic; font-size: 12px; font-weight: 400"
                >Apakah Anda Koordinator?</span
              >
              <q-select
                v-model="data.koordinator"
                :options="koordinatorOption"
                behavior="menu"
                bg-color="white"
                outlined
                dense
